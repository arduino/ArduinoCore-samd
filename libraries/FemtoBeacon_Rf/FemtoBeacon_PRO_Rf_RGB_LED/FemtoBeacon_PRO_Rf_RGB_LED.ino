...
long LED_R_DUTY_CYCLE = 950; // (Brightness: 1 = ON, 1000 = OFF)
long LED_G_DUTY_CYCLE = 980;
long LED_B_DUTY_CYCLE = 999;
...
void loop()
{
  ...
  /*fade colors*/
  //f.fade( red,    green,   256, 5);
  
  //f.fade( green,  blue,     256, 5);
  
  //f.fade( blue,   red,     256, 5);
...
//  delayMicroseconds(1000 - 990);
}


void handleColorPWM(int &led, long &tick, long &duty_cycle , bool &state) {
  if (state) {

...
typedef ModeFilter<int8_t,10> ModeFilterInt8_Size10;
...
typedef ModeFilter<int16_t,10> ModeFilterInt16_Size10;
...
typedef ModeFilter<uint16_t,10> ModeFilterUInt16_Size10;

...
#define _VARIANT_MINITRONICS_20_
...
#define PIN_LED_RXL          (39u)
#define PIN_LED_TXL          (40u)
...
static const uint8_t SS	  = 2;	// SERCOM4 last PAD is present on A2 but HW SS isn't used. Set here only for reference.

...
const PinDescription g_APinDescription[]=
{
 ...
 // ----------------------
  ...
  { PORTA,  1, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1 },  // D46 TFT RST

  // 47 - backlight
  { PORTA,  0, PIO_DIGITAL, PIN_ATTR_PWM_E, No_ADC_Channel, TC2_CH0, TC2_CH0, EXTERNAL_INT_0 },  // D47 TFT BACKLITE

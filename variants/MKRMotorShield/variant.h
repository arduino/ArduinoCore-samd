...
#if !defined(PIN_MAP_STANDARD) && !defined(PIN_MAP_COMPACT) && !defined(PIN_MAP_SUPER_COMPACT)
#define PIN_MAP_STANDARD
#endif
//#define PIN_MAP_COMPACT
//#define PIN_MAP_SUPER_COMPACT
...
#elif defined PIN_MAP_SUPER_COMPACT
  #define NUM_PIN_DESCRIPTION_ENTRIES     (4u)
#else

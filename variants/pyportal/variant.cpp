...
/* NEW PIN DEFS IN PROGRESS:
  ...
  { PORTB,  8, PIO_ANALOG    , PIN_ATTR_ANALOG, ADC_Channel2  , NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8    }, // TOUCH_XR
  ...
  { PORTB, 17, PIO_DIGITAL   , PIN_ATTR_NONE  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // TFT_WR3
  { PORTB, 22, PIO_DIGITAL   , PIN_ATTR_NONE  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6    }, // NEOPIX
  { PORTB, 23, PIO_DIGITAL   , PIN_ATTR_NONE  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7    }, // TFT_WR4
  { PORTB, 30, PIO_DIGITAL   , PIN_ATTR_NONE  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14   }, // SD_CS
  { PORTB, 31, PIO_DIGITAL   , PIN_ATTR_NONE  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15   }, // TFT_BACKLITE

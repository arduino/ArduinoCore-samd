 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 0          | SCL              |  PA17  | RX              | EXTINT[1]      PTX/X[5]  SERCOM1/PAD[1]  SERCOM3_ALT[PAD1]  TCC2/WO[1]  *TCC0_ALT/WO[1] GCLK_IO[3]
 * | 1          | SDA              |  PA16  | TX              |                PTC/X[4]  SERCOM1/PAD[0]  SERCOM3_ALT[PAD0]  TCC2/WO[0]  *TCC0_ALT/WO[0] GCLK_IO[2]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 5          |                  |  PA06  | A0/LED(R)       | EIC/EXTINT[6] *ADC/AIN[6]  AC/AIN[2]  PTC/Y[4]  SERCOM0_ALT/PAD[2]  TCC1/WO[0]
 * | 6          |                  |  PA07  | A1/LED(G)       | EIC/EXTINT[7] *ADC/AIN[7]  AC/AIN[3]  PTC/Y[5]  SERCOM0_ALT/PAD[3]  TCC1/WO[1]  I2S/SD[0]
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 19         |                  |  PA08  | RF1/DIG1        | FECTRL[0]/DIG1   peripheral F
 * | 20         |                  |  PA09  | RF2/DIG2        | FECTRL[1]/DIG2   peripheral F

 * | 21         |                  |  PA27  | LED (B)         | EXTINT[15]  SERCOM3/PAD[0]   GCLK_IO[0]
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
  { PORTA,  8, PIO_FECTRL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DIG1
  { PORTA,  9, PIO_FECTRL, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DIG2

  { PORTA, 27, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 } //,// USB/VBUS

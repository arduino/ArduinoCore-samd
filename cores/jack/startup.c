 ...
 * We need to:
 * 1) Enable XOSC clock (External on-board 12.288MHz oscillator), will be used as DFLL48M reference.
...
void SystemInit( void )
{
  ...
  /* ----------------------------------------------------------------------------------------------
   * 1) Enable XOSC clock (External on-board 12.288 MHz oscillator)
   */
  ...
  GCLK->GENCTRL.reg = GCLK_GENCTRL_ID( GENERIC_CLOCK_GENERATOR_XOSC ) | // Generic Clock Generator 1
                      GCLK_GENCTRL_SRC_XOSC | // Selected source is External 12.288 MHz Oscillator
//                      GCLK_GENCTRL_OE | // Output clock to a pin for tests
  ...
  SYSCTRL->DFLLMUL.reg = SYSCTRL_DFLLMUL_CSTEP( 31 ) | // Coarse step is 31, half of the max value
                         ...
                         SYSCTRL_DFLLMUL_MUL( (VARIANT_MCK/VARIANT_MAINOSC) ) ; // External 12.288MHz is the reference

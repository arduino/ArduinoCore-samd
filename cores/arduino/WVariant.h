...
typedef enum _EPioType
{
  ...
  PIO_TIMER_PWM=8,                    /* The pin is controlled by a TIMER peripheral and is a PWM output. */
  PIO_TIMER_CAPTURE=9,                /* The pin is controlled by a TIMER peripheral and is a capture input. */

  PIO_SERCOM=10,                      /* The pin is controlled by a SERCOM peripheral (UART, SPI, or I2C). */
  PIO_COM=11,                         /* The pin is controlled by the COM peripheral (USB or I2S). */
...
#define PIN_ATTR_TIMER             (PIN_ATTR_TIMER_PWM|PIN_ATTR_TIMER_CAPTURE)

#define PIN_ATTR_SERCOM            (1UL << PIO_SERCOM)
#define PIN_ATTR_COM               (1UL << PIO_COM)
#define PIN_ATTR_AC_CLK            (1UL << PIO_AC_GCLK)
